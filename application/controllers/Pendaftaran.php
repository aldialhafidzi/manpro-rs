...
class Pendaftaran extends CI_Controller
{
  ...
  public function nextTransactionRapol()
  {
    $data['tanggal'] = date('d/m/Y');

    $data['nextBill'] = $this->formatBill('P', '00000');
    $data['nextMR'] = $this->formatMR('00000');
    $data['nextReg'] = $this->formatReg('00000');
    ...
    $data['lastTransaksi'] = $this->TransaksiModel->lastRecord();
    if ($data['lastTransaksi']) {
      $data['nextBill'] = $this->formatBill('P', $data['lastTransaksi']->id);
      $data['nextReg'] = $this->formatReg($data['lastTransaksi']->no_reg);
    }
  ...
  public function nextTransactionRaradiologi()
  {
    $data['tanggal'] = date('d/m/Y');

    $data['nextBill'] = $this->formatBill('R', '00000');
    $data['nextMR'] = $this->formatMR('00000');
    $data['nextReg'] = $this->formatReg('00000');
    ...
    $data['lastTransaksi'] = $this->TransaksiModel->lastRecord();
    if ($data['lastTransaksi']) {
      $data['nextBill'] = $this->formatBill('R', $data['lastTransaksi']->id);
      $data['nextReg'] = $this->formatReg($data['lastTransaksi']->no_reg);
    }
  ...
  public function nextTransactionRalab()
  {
    $data['tanggal'] = date('d/m/Y');

    $data['nextBill'] = $this->formatBill('L', '00000');
    $data['nextMR'] = $this->formatMR('00000');
    $data['nextReg'] = $this->formatReg('00000');
    ...
    $data['lastTransaksi'] = $this->TransaksiModel->lastRecord();
    if ($data['lastTransaksi']) {
      $data['nextBill'] = $this->formatBill('L', $data['lastTransaksi']->id);
      $data['nextReg'] = $this->formatReg($data['lastTransaksi']->no_reg);
    }
  ...
  public function generateBuktiPendaftaranRapol($data)
  {
    $this->pdf->setPaper('A4', 'potrait');
    ...
    $html =
      '<html>
            ...
            <body>
              <div style="border: 2px dashed rgb(0, 0, 0); padding: 1rem;">
                <h1 style="text-align:center;">BUKTI PENDAFTARAN RAWAT POLI</h1>
                <h3 style="text-align:center;">MANPRO-RS</h3>
                <p style="text-align:center;font-weight: 500;">Jl. Gunung Puntang No.3 Kabupaten Bandung Kecamatan Banjaran 40377
                </p>
                <hr style="border: 2px solid;margin-bottom:2rem;">
  ...
  public function generateBuktiPendaftaranRaradiologi($data)
  {
    $this->pdf->setPaper('A4', 'potrait');
    ...
    $html =
      '<html>
            ...
            <body>
              <div style="border: 2px dashed rgb(0, 0, 0); padding: 1rem;">
                <h1 style="text-align:center;">BUKTI PENDAFTARAN RAWAT RADIOLOGI</h1>
                <h3 style="text-align:center;">MANPRO-RS</h3>
                <p style="text-align:center;font-weight: 500;">Jl. Gunung Puntang No.3 Kabupaten Bandung Kecamatan Banjaran 40377
                </p>
                <hr style="border: 2px solid;margin-bottom:2rem;">
  ...
  public function generateBuktiPendaftaranRalab($data)
  {
    $this->pdf->setPaper('A4', 'potrait');
    ...
    $html =
      '<html>
            ...
            <body>
              <div style="border: 2px dashed rgb(0, 0, 0); padding: 1rem;">
                <h1 style="text-align:center;">BUKTI PENDAFTARAN RAWAT LAB</h1>
                <h3 style="text-align:center;">MANPRO-RS</h3>
                <p style="text-align:center;font-weight: 500;">Jl. Gunung Puntang No.3 Kabupaten Bandung Kecamatan Banjaran 40377
                </p>
                <hr style="border: 2px solid;margin-bottom:2rem;">
  ...
  public function rawat_poli()
  {
    $data                 = $this->nextTransactionRapol();
    $data['tipe_pasien']  = $this->TipePasienModel->get_all();
    $data['title']        = 'MANPRO-RS | Pendaftaran';
    $data['page']         = 'rawat_poli';

    $this->load->view('headers/normal_header', $data);
    $this->load->view('pages/rawat_poli');
    $this->load->view('footers/normal_footer');
  }

  public function rawat_radiologi()
  {
    $data                 = $this->nextTransactionRaradiologi();
    $data['tipe_pasien']  = $this->TipePasienModel->get_all();
    $data['title']        = 'MANPRO-RS | Pendaftaran';
    $data['page']         = 'rawat_radiologi';

    $this->load->view('headers/normal_header', $data);
    $this->load->view('pages/rawat_radiologi');
    $this->load->view('footers/normal_footer');
  }

  public function rawat_lab()
  {
    $data                 = $this->nextTransactionRalab();
    $data['tipe_pasien']  = $this->TipePasienModel->get_all();
    $data['title']        = 'MANPRO-RS | Pendaftaran';
    $data['page']         = 'rawat_lab';

    $this->load->view('headers/normal_header', $data);
    $this->load->view('pages/rawat_lab');
    $this->load->view('footers/normal_footer');
  }
    ...
    if ($insert_or_update) {
      ...
      if ($transaksi_id) {
        ...
        if ($this->DetailTransaksiModel->insert($data_detail_transaksi)) {
          ...
          $download_url             = $this->generateBuktiPendaftaranRapol($transaksi);
    ...
    if ($insert_or_update) {
      ...
      if ($transaksi_id) {
        ...
        $data_detail_transaksi = array(
          ...
          'obat_id'           => NULL,
          'ruangan_id'        => NULL,
          'parameter_radiologi_id' => $this->input->post('parameter_radiologi_id', TRUE) || NULL,
          'kamar_id'          => NULL,
          'bed_id'            => NULL,
          'tanggal_masuk'     => NULL,
          'tanggal_keluar'    => NULL,
        ...
        if ($this->DetailTransaksiModel->insert($data_detail_transaksi)) {
          ...
          $download_url             = $this->generateBuktiPendaftaranRaradiologi($transaksi);
    ...
    if ($insert_or_update) {
      ...
      if ($transaksi_id) {
        ...
        $data_detail_transaksi = array(
          ...
          'obat_id'           => NULL,
          'ruangan_id'        => NULL,
          'parameter_diagnosa_id' => $this->input->post('parameter_diagnosa_id', TRUE) || NULL,
          'kamar_id'          => NULL,
          'bed_id'            => NULL,
          'tanggal_masuk'     => NULL,
          'tanggal_keluar'    => NULL,
        ...
        if ($this->DetailTransaksiModel->insert($data_detail_transaksi)) {
          ...
          $download_url             = $this->generateBuktiPendaftaranRalab($transaksi);
