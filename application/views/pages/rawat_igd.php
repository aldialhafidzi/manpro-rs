<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h5 class="m-0 text-dark title-danger"><i class="fas fa-clinic-medical nav-icon"></i> &nbsp;Pendaftaran Rawat IGD</h5>
                </div>
    ...
    <div class="content">
        <div class="container-fluid">
            <form id="form_rawat_igd" action="" method="POST">
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-12">
                                        ...
                                        <div class="tab-content" id="custom-tabs-one-tabContent">
                                            <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-6">
                                                        ...
                                                        <select disabled id="kota" name="kota" class="select-kota form-control form-control-sm ">
                                                        </select>
                                                    </div>
                                                    <div class="col-6">
                                                        <label for="">Kecamatan</label>
                                                        <select disabled id="kecamatan" name="kecamatan" class="select-kecamatan form-control form-control-sm ">
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-6">
                                                        ...
                                                        <select disabled id="kelurahan" name="kelurahan" class="select-kelurahan form-control form-control-sm ">
                                                        </select>
                                                    </div>
                                                    <div class="col-3">
                                                        <label for="">RT</label>
                                            ...
                                            <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-6">
                                                        <label for="">Kota</label>
                                                        <select disabled id="kota_pj" name="kota_pj" class="select-kota_pj form-control form-control-sm ">
                                                        </select></div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-6">
                                                        <label for="">Kecamatan</label>
                                                        <select disabled id="kecamatan_pj" name="kecamatan_pj" class="select-kecamatan_pj form-control form-control-sm ">
                                                        </select> </div>
                                                    <div class="col-6">
                                                        <label for="">Kelurahan</label>
                                                        <select disabled id="kelurahan_pj" name="kelurahan_pj" class="select-kelurahan_pj form-control form-control-sm ">
                                                        </select> </div>
                                                </div>
                                                ...
                                                <div class="form-group row mt-3 m-0" style="border:1px dashed #ff6e08; padding:1rem; padding-bottom:0; border-radius:4px;">
                                                    ...
                                                    <div class="col-12">
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td id="tersedia"><?php echo $tersedia ?> </td>
                                                                    <td id="terisi"> <?php echo $terisi ?> </td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#form_rawat_igd").submit(function(e) {
            e.preventDefault();
            $(".app").loading();
            var data = {
            ...
            $.ajax({
                url: '<?= base_url() ?>pendaftaran/raigd',
                type: 'POST',
                data: data,
                success: function(data) {
                    $(".app").loading('stop');
                    ...
                    $('#tersedia').html(parseInt($('#tersedia').html()) - 1);
                    $('#terisi').html(parseInt($('#terisi').html()) + 1);
                    toastr.success("Pasien rawat igd berhasil didaftarkan");
                    $('#form_rawat_igd').trigger("reset");
