  ...
  <div class="content-header">
    ...
    color: #ffff !important;"><i class="fas fa-procedures nav-icon"></i> &nbsp;Ruang Rawat</h5>
        ...
        <div class="btn-group" style="margin: 0px 5px 0px 5px">
          <button type="button" class="btn btn-default" style="width: 140px">Lantai 3</button>
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a class="dropdown-item active" href="<?= base_url() ?>ruangrawat/lantai3">Lantai 3</a></li>
          </ul>
        </div>
