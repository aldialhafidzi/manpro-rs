<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-7">
          <h1 class="m-0 text-dark">Ruang Rawat Kelas 1</h1>
        </div>

        <div class="btn-group" style="margin: 0px 5px 0px 5px">
          <button type="button" class="btn btn-default" style="width: 140px">Kelas 1</button>
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class="divider"></li>
            <li><a class="dropdown-item active" href="<?= base_url() ?>ruangrawat/ruang_k1">Kelas 1</a></li>
