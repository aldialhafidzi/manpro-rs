<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark title-primary"> <i class="fas fa-ambulance nav-icon"></i> &nbsp; Rekam IGD</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?= base_url() ?>rekam-medis/delete" method="POST">
                    ...
                    <input type="hidden" id="jenis_rawat" name="jenis_rawat" value="RAWAT-IGD">
...
<div class="modal fade" id="modal_rekam_igd" tabindex="-1" role="dialog" aria-labelledby="modal_rekam_igdTitle" aria-hidden="true" style="overflow-y: auto;">
...
<script>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                data.rekam.forEach((element, i) => {
                    ...
                    let namater = '-';
                    let nama_penyakit = '-';
                    let jenis_rawat = element.jenis_rawat === 'RAWAT-JALAN' ? 'JALAN' : 'IGD';
    ...
    $('#tableRekamIGD').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": '<?= base_url() ?>rekam-medis/rekam-igd-all',
            "type": "POST",
        },
    });
