            ...
            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
              <thead>
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 233px;">spec_id</th>
              ...
              <?php 
               ...
               foreach ($dokter_poli as $dr_pl): ?>
                <tr>
                  <td><?php echo $no++ ?></td>
                  <td><?php echo $dr_pl->nama?></td>
                  <td><?php echo $dr_pl->no_telp?></td>
                  <td><?php echo $dr_pl->spec_id?></td>
                  <td><?php echo $dr_pl->status?></td>
                  <?php if ($user == 1) : ?>
                  <td onclick="javascript:return confirm('Anda yakin hapus ?')"><?php echo anchor('Poliklinik/hapus_dokter/'.$dr_pl->id, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
                  <td><?php echo anchor('poliklinik/edit_dokter/'.$dr_pl->id,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
                  <?php endif;?>
                </tr>
              <?php endforeach ?>
            </table>
