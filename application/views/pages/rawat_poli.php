<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h5 class="m-0 text-dark title-primary"><i class="fas fa-ambulance nav-icon"></i> &nbsp;Pendaftaran Rawat Poli</h5>
                </div>
    ...
    <div class="content">
        <div class="container-fluid">
            <form id="form_rawat_poli" action="" method="POST">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <input id="no_mr" name="no_mr" type="text" disabled class="form-control form-control-sm col-7" form="form_rawat_poli" value="<?= $nextMR ?>">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#form_rawat_poli").submit(function(e) {
            e.preventDefault();
            $(".app").loading();
            var data = $("#form_rawat_poli").serializeArray();
            data.push({
                name: "no_mr",
                value: $('#no_mr').val()
            });
            $.ajax({
                url: '<?= base_url() ?>pendaftaran/rapol',
                type: 'POST',
                dataType: 'JSON',
                data: data,
                success: function(data) {
                    ...
                    toastr.success("Pasien rawat poli berhasil didaftarkan");
                    ...
                    var validator = $("#form_rawat_poli").validate();
                    validator.resetForm();
