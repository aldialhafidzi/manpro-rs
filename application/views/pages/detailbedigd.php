...
<div class="card">
          ...
          <div class="row">
            <div class="col-1">
              <label>Detail</label> 
                        ...
                        <div class="col-5">
              <label>NO PASIEN : <?php echo $detail_transaksi->transaksi->pasien->no_mr ?></label> 
            </div>
  ...
  <div class="card-body">
    <div class="row">
      <div class="col-2">
        <p>Nama : <?php echo $detail_transaksi->transaksi->pasien->nama?></p>
      </div>
      <div class="col-2">
        <p>Kelamin : <?php echo $detail_transaksi->transaksi->pasien->jenis_kelamin?></p>
      </div>
      <div class="col-3">
        <p>Lahir : <?php echo $detail_transaksi->transaksi->pasien->tanggal_lahir ?></p>
      </div>
    ...
    <div class="row">
      <div class="col-5">
        <p>Alamat : <?php echo $detail_transaksi->transaksi->pasien->kota ?> Telp.<?php echo $detail_transaksi->transaksi->pasien->no_telp ?></p>
      </div>
                  <div class="col-3">
