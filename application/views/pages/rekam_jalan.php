<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 text-dark title-primary"> <i class="fas fa-ambulance nav-icon"></i> &nbsp; Rekam Jalan</h5>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="modal_add" tabindex="-1" role="dialog" aria-labelledby="modal_addTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="http://localhost/manpro-rs/rekam-medis/add" method="POST">
...
<script>
    ...
    $('#tableRekamJalan').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": 'http://localhost/manpro-rs/rekam-medis/rekam-jalan-all',
            "type": "POST",
        },
    });
