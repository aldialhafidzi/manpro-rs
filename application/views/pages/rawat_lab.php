<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h5 class="m-0 text-dark title-primary"><i class="fas fa-ambulance nav-icon"></i> &nbsp;Pendaftaran Rawat Lab</h5>
                </div>
    ...
    <div class="content">
        <div class="container-fluid">
            <form id="form_rawat_lab" action="" method="POST">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card card-secondary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mt-3 m-0" style="border:1px dashed #ff6e08; padding:1rem; padding-bottom:0; border-radius:4px;">
                                    ...
                                    <div class="col-12">
                                        <label>Parameter Diagnosa</label>
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <input id="no_mr" name="no_mr" type="text" disabled class="form-control form-control-sm col-7" form="form_rawat_lab" value="<?= $nextMR ?>">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.select-parameter-diagnosa').select2({
            ...
            placeholder: "Pilih parameter diagnosa",
            allowClear: true,
            ajax: {
                url: '<?= base_url() ?>parameter-diagnosa/search',
                dataType: 'JSON',
                method: 'GET',
                data: function(params) {
                    return {
        ...
        $('.btn-reset-form').click(function() {
            $('#form_rawat_lab').trigger("reset");
            $('#selected-poliklinik').html('');
            $('#selected-diagnosa').html('');
            $('#poliklinik_id').empty();
            $('#tipe_pasien').empty();
            $("#diagnosa_id").empty();
            $("#parameter-diagnosa_id").empty();
        });

        $("#form_rawat_lab").submit(function(e) {
            e.preventDefault();
            $(".app").loading();
            var data = $("#form_rawat_lab").serializeArray();
            data.push({
                name: "no_mr",
                value: $('#no_mr').val()
            });
            $.ajax({
                url: '<?= base_url() ?>pendaftaran/ralab',
                type: 'POST',
                dataType: 'JSON',
                data: data,
                success: function(data) {
                    ...
                    toastr.success("Pasien rawat lab berhasil didaftarkan");
                    ...
                    var validator = $("#form_rawat_lab").validate();
                    validator.resetForm();
